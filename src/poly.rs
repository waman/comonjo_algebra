...
use std::{collections::{btree_map, BTreeMap, HashMap}, fmt::{Debug, Display}, 
          iter::Enumerate, ops::*, slice::Iter, vec::{self, IntoIter}};
...
use crate::{algebra::*, poly::{dense::DenseContent, sparse::SparseContent}};
